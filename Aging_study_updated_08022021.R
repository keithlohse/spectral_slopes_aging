...
# This data file was then processed in Python 3.9.2 using FOOOF 1.0.0 to 
# obtain the offsets and exponents in the Aging_study_FOOOF_var.csv file
# These processed data are used in the statistical analyses
...
# Y ~ X + M
mod3 <- lm(list_rec~group+Exponent,
           data=NO_MCI[NO_MCI$list_rec!="NA",])
summary(mod3)
...
# Y ~ X + M
mod3 <- lm(fig_rec~group+Exponent,
           data=NO_MCI[NO_MCI$fig_rec!="NA",])
summary(mod3)
